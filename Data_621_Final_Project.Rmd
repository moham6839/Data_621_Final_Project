...
mydata.clean %>%
  ...
  geom_text(aes(label = paste0(round(percentage, 1), "%")), 
     ...
     labs(title = "Distribution of Chest Pain Levels Among Each Gender with Heart Disease", 
...
For participants with heart disease, there appears to be more participants who have the disease around their 50s, while those without the disease shows a skewness to the left, 
...
Participants reporting chest pain levels 1 to 3 
